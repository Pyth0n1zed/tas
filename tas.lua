...
gui:CreateButton(read,"trigger","Enable anti epilepsy","puts a near-opaque black full screen gui on ur screen",6,function() local gui=Instance.new("ScreenGui",game.Players.LocalPlayer.PlayerGui)local frame=Instance.new("Frame",gui) frame.Size = UDim2.new(1,0,1,0) frame.BackgroundTransparency = 0.1 frame.BackgroundColor3 = Color3.fromRGB(0,0,0) gui.IgnoreGuiInset = true end)
...
gui:CreateButton(main,"trigger","Tower of Genesis","3.5 mins",1,function()MacroTower("ToG",210)end)
gui:CreateButton(main,"trigger","Tower of Motion Evolution","3.5 mins",2,function()MacroTower("ToME",210)end)
gui:CreateButton(main,"trigger","Tower of Buttons","3.5 mins",3,function()MacroTower("ToB",210)end)
gui:CreateButton(r1,"trigger","Tower of Impossible Expectations","3.5 mins",14,function()MacroTower("ToIE",210)end)
gui:CreateButton(r1,"trigger","Tower of True Skill","36 seconds",15,function()MacroTower("ToTS",17)end)
...
gui:CreateButton(r2,"trigger","Tower of Difficulty Chart","3 mins",15,function()MacroTower("ToDC",180)end)
gui:CreateButton(r2,"trigger","Tower of Eternal Suffering","3 mins",13,function()MacroTower("ToES",180)end)
gui:CreateButton(r3,"trigger","Tower of Confusion","4 mins",13,function()MacroTower("ToC",240)end)
